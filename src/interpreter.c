...
int run_program(Resources * resources){
    ...
    instrucion_symbols[20] = "MOV_INT_MEM";
    instrucion_symbols[21] = "MOV_INT_CONST";
    instrucion_symbols[22] = "MOV_DBL_MEM";
    instrucion_symbols[23] = "MOV_DBL_CONST";
    instrucion_symbols[24] = "CAST_INT_MEM";
    instrucion_symbols[25] = "CAST_DBL_MEM";
    instrucion_symbols[26] = "PUSH_EMPTY";
    instrucion_symbols[27] = "PUSH_INT_CONST";
    instrucion_symbols[28] = "PUSH_DBL_CONST";
    instrucion_symbols[29] = "PUSH_INDEX_CONST";
    instrucion_symbols[30] = "PUSH_INT_MEM";
    instrucion_symbols[31] = "PUSH_DBL_MEM";
    instrucion_symbols[32] = "PUSH_INDEX_MEM";
    instrucion_symbols[33] = "POP_EMPTY";
    instrucion_symbols[34] = "JMP_MEM";
    instrucion_symbols[35] = "JMP_TRUE_MEM";
    instrucion_symbols[36] = "JMP_FALSE_MEM";
    instrucion_symbols[37] = "FCE_CALL";
    instrucion_symbols[38] = "FCE_RETURN";
    instrucion_symbols[39] = "CIN_INT";
    instrucion_symbols[40] = "CIN_DOUBLE";
    instrucion_symbols[41] = "CIN_STRING";
    instrucion_symbols[42] = "CONCAT_MEM_MEM";
    instrucion_symbols[43] = "CONCAT_MEM_CONST";
    instrucion_symbols[44] = "CONCAT_CONST_CONST";
    instrucion_symbols[45] = "SUBSTR_MEM_MEM";
    instrucion_symbols[46] = "LENGTH_MEM";
    instrucion_symbols[47] = "LENGTH_CONST";
    instrucion_symbols[48] = "FIND_MEM_MEM";
    instrucion_symbols[49] = "FIND_MEM_CONST";
    instrucion_symbols[50] = "FIND_CONST_CONST"; 
    instrucion_symbols[51] = "SORT_MEM";  
    instrucion_symbols[52] = "SORT_CONST"; 
    instrucion_symbols[53] = "COUT_MEM_INT"; 
    instrucion_symbols[54] = "COUT_MEM_DBL";
    instrucion_symbols[55] = "COUT_MEM_STRING";
    instrucion_symbols[56] = "COUT_CONST_INT";
    instrucion_symbols[57] = "COUT_CONST_DBL";
    instrucion_symbols[58] = "COUT_CONST_STRING";
    instrucion_symbols[59] = "HALT";

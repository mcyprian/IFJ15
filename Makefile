...
interpreter: main.o scanner.o dynamic_buffer.o dynamic_structure_buffer.o syntax_analysis.c precedence_analysis.o stack.o built_functions.o ial.o semantics.o symbol_table.o interpreter.o instructions.o
	$(CC) main.o scanner.o dynamic_buffer.o dynamic_structure_buffer.o syntax_analysis.c precedence_analysis.o stack.o built_functions.o ial.o semantics.o symbol_table.o interpreter.o instructions.o -o interpreter
...
pack:
	tar -zcvf xscavn00.tgz *.h *.c Makefile rozsireni
